      ...
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="flex flex-col items-center justify-center flex-1 px-4 py-8">
          <div className="w-full max-w-md space-y-6 text-center">
            <h1 className="text-2xl font-bold text-foreground">{t('auth.resetPassword.invalidLink.title')}</h1>
            <p className="text-muted-foreground">{t('auth.resetPassword.invalidLink.description')}</p>
      ...
      >
        {logoSrc ? (
          <img
            ...
            src={logoSrc}
            alt="logo"
            className="w-auto max-w-lg mx-auto space-y-8 text-center h-36 drop-shadow-xl lg:h-56"
          />
        ) : null}
      </div>
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-4 py-8">
        <div className="w-full max-w-md space-y-10">
          ...
          <div className="space-y-8">
            <h1 className="text-3xl font-bold text-center text-foreground">{t('auth.resetPassword.title')}</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute w-5 h-5 -translate-y-1/2 text-muted-foreground top-1/2 left-3" />
                  <Input
                    id="password"
                    type="password"
              ...
              <Button
                type="submit"
                variant="default"
                className="w-full h-12 font-medium transition-all rounded-full shadow-md"
                disabled={isLoading}
              >
