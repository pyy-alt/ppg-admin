          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Select
              ...
              onValueChange={(value) => {
                ...
                setFromDate(calculateDateRange(value).from);
                setToDate(calculateDateRange(value).to);
              }}
            >
			...
			<div className="px-6 py-6">
				...
				<div className="lg:items-cente mb-6 flex flex-col items-center justify-between gap-4 lg:flex-row">
					<div className="flex flex-wrap items-center gap-3">
						...
						<Select defaultValue={dateRangePreset} onValueChange={value => setDateRangePreset(value)}>
							<SelectTrigger className="w-40">
								<SelectValue placeholder="Date Range" />
							</SelectTrigger>
							<SelectContent>
				...
				{repairOrders.length === 0  && user?.person?.type === 'Shop' ? (
					<div>
						<Empty>
							<EmptyHeader>
				...
				) :  repairOrders.length === 0  && user?.person?.type === 'ProgramAdministrator' ? (
					<div>
						<Empty>
							<EmptyHeader>
								<EmptyMedia variant="icon">
