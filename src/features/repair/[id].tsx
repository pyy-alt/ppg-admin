      ...
      <div className="relative w-full h-40">
        ...
        <div className="absolute -translate-y-1/2 top-1/2 left-6">
          ...
          <p className="flex items-center mt-4 space-x-4 text-sm text-gray-200">
            ...
            <span>
              {t('repairOrder.detail.assignedDealership')}: {user?.person?.shop?.sponsorDealership.name ?? '--'} (
              {user?.person?.shop?.sponsorDealership.dealershipNumber})
            </span>
            <Users className="w-5 h-5 ml-6 text-white" />
            <span>
              {user?.person?.type === 'ProgramAdministrator' ? t('user.type.admin') : user?.person?.type}:{' '}
          ...
          <div className="grid grid-cols-1 gap-8 p-5 md:grid-cols-3">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p>
                  {formatDateOnly(initRepaitOrderData?.dateLastSubmitted as Date) || '--'} by{' '}
              ...
              <div>
                ...
                <p className="font-medium">
                  {initRepaitOrderData?.dealership?.name || '--'} ({initRepaitOrderData?.dealership?.dealershipNumber})
                </p>
              </div>
              <div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {initRepaitOrderData && initRepaitOrderData?.preRepairPhotoFileAssets
