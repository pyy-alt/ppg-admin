      ...
      authApi.registrationComplete(request, {
        ...
        error: (error: Error) => {
          ...
          if (
            ...
            console.log(
              '[registrationComplete] API returned plain text, treating as success'
            );
            auth.reset();
            toast.success(t('registration.complete.success'));
            navigate({
    ...
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <div className="bg-primary text-primary-foreground relative mt-12 h-32 lg:h-40">
        ...
        <div className="relative z-10 flex h-full items-center px-6 lg:px-12">
          <h1 className="text-2xl font-bold lg:text-4xl">{getBannerTitle()}</h1>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-start justify-center px-4 py-8 lg:py-12">
        <form onSubmit={handleSubmit} className="w-full max-w-4xl space-y-10">
            ...
            {userType === 'FieldStaff' && (
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={
                      auth.user?.person?.fieldStaffRegions
                        ?.map((r: any) => r.name)
                        .join(', ') || '--'
                    }
                    className="bg-muted h-12 rounded-lg"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={t(
                      'registration.complete.placeholders.password'
                    )}
                  ...
                  <button
                    ...
                    aria-label={
                      showPassword
                        ? t('registration.complete.hidePassword')
                        : t('registration.complete.showPassword')
                    }
                  >
                    {showPassword ? (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={t(
                      'registration.complete.placeholders.confirmPassword'
                    )}
          ...
          <div className="flex justify-end pt-6">
            ...
            >
              {isLoading
                ? t('registration.complete.completing')
                : t('registration.complete.submit')}
            </Button>
          </div>
        </form>
      </div>
